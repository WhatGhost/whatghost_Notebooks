...
> **配图建议：触发 skill**  
> 建议插入智能体输入框截图，展示使用自然语言或当前 agent 支持的显式调用方式触发工作流。
...
<img width="388" height="252" alt="lmf04" src="https://github.com/user-attachments/assets/d71c51a2-5fbd-4fd5-8a34-da59ca976de8" />
...
| WebUI 字段 | 建议值 | 来源 |
|---|---|---|
| Model path | `models/Qwen3.5-2B` | Stage 2 模型准备 |
| Template | `qwen3_nothink` | 模型注册表解析 |
| Dataset | `identity,alpaca_zh_demo` | Stage 1 数据准备 |
| Finetuning method | `lora` | Stage 0 微调类型 |
| Output dir | `saves/qwen3-1.7b/lora/sft_20260622_1530` | 本次实验路径 |
